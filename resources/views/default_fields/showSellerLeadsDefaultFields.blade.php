...
@section('title', 'Customizing Default Fields > Seller Leads/Properties')
        ...
        <div class="row">
            <div class="col-md-12">	
                ...
                <div>
                    ...
                    <form action="{{ route('seller_leads_default_fields.updateValue', $field->id) }}" method="post">
                        {{ csrf_field() }}
                            ...
                            <div class="modal-dialog" style="width: 700px;">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="{{ route('seller_leads_default_fields.update', $field->id) }}" method="post">
                                            {{ csrf_field() }}
                                            <div class="row">
                                                <div class="col-lg-12">
    ...
    <div class="modal fade" id="modal-add">
        <div class="modal-dialog" style="width: 700px;">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('store_seller_leads_default_fields') }}" method="post">
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="col-lg-12 {{ $errors->has('label') ? 'has-error' : '' }}">
