...
{ 
    ...
    public function show() {
        if(isset($_COOKIE["company_id"]) && $_COOKIE["company_id"] != 0) {
            $fields = SellerLeadsDefaultFields::where('company_id', $_COOKIE["company_id"])->get();
            return view('default_fields.showSellerLeadsDefaultFields', compact('fields'));
        } else {
            return view('default_fields.index');
        }
    }
	...
	public function store(StoreRoleRequest $request) {
        ...
        if(isset($_COOKIE["company_id"]) && $_COOKIE["company_id"] != 0) {
            ...
            $field = SellerLeadsDefaultFields::create($result);
